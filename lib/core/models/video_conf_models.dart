...
//
//     final videoConfModel = videoConfModelFromJson(jsonString);

import 'dart:convert';

VideoConfModel videoConfModelFromJson(String str) =>
    VideoConfModel.fromJson(json.decode(str));

String videoConfModelToJson(VideoConfModel data) => json.encode(data.toJson());

class VideoConfModel {
  Data? data;
  Meta? meta;
  ...
  factory VideoConfModel.fromJson(Map<String, dynamic> json) => VideoConfModel(
