...
class SecuritySolutionsView extends StatefulWidget {
  const SecuritySolutionsView({super.key});

  @override
  State<SecuritySolutionsView> createState() => _SecuritySolutionsViewState();
}

class _SecuritySolutionsViewState extends State<SecuritySolutionsView> {
  bool mobile = false;
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<SecuritySolutionsViewModel>(
      onModelReady: (model) {
        model.getSecuritySolutions();
      },
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Center(
                        child: Text(
                          '${model.securitySolutionsModel?.data?.attributes?.hero?.heading}',
                      ...
                      Padding(
                        ...
                        child: Text(
                          '${model.securitySolutionsModel?.data?.attributes?.hero?.subheading}',
                        ),
                      ),
                      Center(
                        child: Text(
                          '${model.securitySolutionsModel?.data?.attributes?.listItem?.heading}',
                          style: const TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                          ),
                      ...
                      Text(
                        '➠${model.securitySolutionsModel?.data?.attributes?.listItem?.list?[0].item}',
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
                        '➠${model.securitySolutionsModel?.data?.attributes?.listItem?.list?[1].item}',
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      Padding(
                        ...
                        child: Text(
                          '➠${model.securitySolutionsModel?.data?.attributes?.listItem?.list?[2].item}',
                        ),
                      ),
                      const SizedBox(
                        height: 10,
                      ...
                      Text(
                        '➠${model.securitySolutionsModel?.data?.attributes?.listItem?.list?[3].item}',
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
                        '➠${model.securitySolutionsModel?.data?.attributes?.listItem?.list?[4].item}',
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      Text(
                        '➠${model.securitySolutionsModel?.data?.attributes?.listItem?.list?[5].item}',
                      ),
