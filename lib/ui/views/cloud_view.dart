              ...
              return SafeArea(
                ...
                child: Column(
                  children: [
                    ...
                    Center(
                      child: Text(
                        '${model.cloudModel?.data?.attributes?.hero?[0].heading}',
                    ...
                    Padding(
                      ...
                      child: Text(
                          '${model.cloudModel?.data?.attributes?.hero?[0].subheading}'),
                    ),
                    Center(
                      child: Text(
                        '${model.cloudModel?.data?.attributes?.hero?[1].heading}',
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 24,
                        ),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(50.0),
                      child: Text(
                          '${model.cloudModel?.data?.attributes?.hero?[1].subheading}'),
                    ),
                    Padding(
                      padding: const EdgeInsets.all(50.0),
                      child: Center(
                        child: Text(
                          '${model.cloudModel?.data?.attributes?.infrastructures?.heading}',
                          style: const TextStyle(
                            fontWeight: FontWeight.bold,
                            fontSize: 24,
                          ),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 50.0, bottom: 10, left: 50, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.infrastructures?.list?[0].item}'),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                          bottom: 10, left: 50, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.infrastructures?.list?[1].item}'),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                          bottom: 50, left: 50, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.infrastructures?.list?[2].item}'),
                    ),
                    Center(
                      child: Text(
                        '${model.cloudModel?.data?.attributes?.element?[0].heading}',
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 24,
                        ),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(50.0),
                      child: Text(
                          '${model.cloudModel?.data?.attributes?.element?[0].subheading}'),
                    ),
                    Center(
                      child: Text(
                        '${model.cloudModel?.data?.attributes?.element?[1].heading}',
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 24,
                        ),
                    ...
                    Padding(
                      padding: const EdgeInsets.all(50.0),
                      child: Text(
                          '${model.cloudModel?.data?.attributes?.element?[1].subheading}'),
                    ),
                    Center(
                      child: Text(
                        '${model.cloudModel?.data?.attributes?.content?.heading}?',
                        style: const TextStyle(
                          fontWeight: FontWeight.bold,
                          fontSize: 24,
                        ),
                    ...
                    Padding(
                      padding: const EdgeInsets.only(
                          top: 50.0, bottom: 10, left: 50, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.content?.list?[0].item}'),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                          bottom: 10, left: 90, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.content?.list?[1].item}'),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                          bottom: 10, left: 20, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.content?.list?[2].item}'),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(
                          bottom: 50, left: 90, right: 50),
                      child: Text(
                          '➠${model.cloudModel?.data?.attributes?.content?.list?[3].item}'),
                    ), // Companies
                    // Companies
                    const SizedBox(
                      height: 100,
