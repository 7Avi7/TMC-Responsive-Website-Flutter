...
class VideoConfView extends StatefulWidget {
  const VideoConfView({super.key});

  @override
  State<VideoConfView> createState() => _VideoConfViewState();
}

class _VideoConfViewState extends State<VideoConfView> {
  bool mobile = false;
  ...
  Widget build(BuildContext context) {
    ...
    return BaseView<VideoConfViewModel>(
      onModelReady: (model) {
        model.getVideoConf();
      },
                ...
                child: SingleChildScrollView(
                  child: Column(
                    children: [
                      ...
                      Center(
                        child: Text(
                          '${model.videoConfModel?.data?.attributes?.hero?.heading}',
                      ...
                      Padding(
                        ...
                        child: Text(
                            "${model.videoConfModel?.data?.attributes?.hero?.subheading}"),
                      ),
                      Center(
                        child: Text(
                          '${model.videoConfModel?.data?.attributes?.features?.heading}',
                          style: const TextStyle(
                            fontSize: 24,
                            fontWeight: FontWeight.bold,
                          ),
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[0].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[1].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[2].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[3].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[4].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[5].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[6].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[7].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[8].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[9].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[10].item}")),
                          ],
                        ),
                      ),
                      Padding(
                        ...
                        child: Row(
                          children: [
                            Flexible(
                                child: Text(
                                    "⦾ ${model.videoConfModel?.data?.attributes?.features?.list?[11].item}")),
                          ],
                        ),
                      ),
                      const SizedBox(
